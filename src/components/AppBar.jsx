        ...
        <header className="flex px-8 py-4 justify-between shadow mb-4">
            ...
            <div className="flex items-center">
                ...
                <div onClick={() => {setfocused("cart")}} className="inline-block relative group md:text-lg">
                    <Link to="/cart">
                        <div className="absolute bottom-4 left-4 w-4 h-4 bg-purple-700 border rounded-full text-white text-xs flex justify-center items-center font-semibold">{cartItems.length}</div>
